/**
 * ALL SERVICES - Scenario 2: Gradual Ramp-up of Users (HIGH PRESSURE)
 *
 * Gradually increases concurrent users from 0 → 50 → 100 → 200 across all 4
 * services, holds at 200 VUs for 5 minutes, then ramps back down.
 * The gradual ramp lets you observe autoscaling at each step.
 *
 * Run:  k6 run gradual-rampup.js
 */
...
export const options = {
  stages: [
    ...
    { duration: '2m', target: HIGH_VUS },      // Ramp-up to 200 users
